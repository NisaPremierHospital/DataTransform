...
*/
async function qProcedureNursingTask({daterange}) {
  ...
  try{
    ...
    const [rows, fields] = await connection.execute(
      ...
      patient_procedure_nursing_task.id AS patient_procedure_nursing_task_id,
      ...
      INNER JOIN 
      patient_procedure_nursing_task ON patient_procedure_nursing_task.patient_procedure_id = patient_procedure.id
      LEFT JOIN 
      service_centre ON patient_procedure.service_centre_id = service_centre.id
      LEFT JOIN nursing_service ON nursing_service.id = patient_procedure_nursing_task.service_id
...
// WHERE patient_procedure.patient_id = 5
// AND patient_procedure_nursing_task.patient_procedure_id = 20
module.exports = qProcedureNursingTask
